...
const channels = [
  ...
  },
  {
    ...
    strengths: ["팔로워 바깥까지 급속하게 확산됩니다", "해시태그로 노출을 키울 수 있습니다", "토론·비교 관점이 자연스럽게 반응을 만듭니다", "미디어·인플루언서와 연결되기 쉬운 구조입니다"],
    fits: ["앱 · 디지털 서비스", "건강 · 웰니스", "이슈성 제품", "비교 가능한 카테고리"],
    tactics: ["의견 확산", "비교 관점", "질문 유도"]
  },
  {
    id: "wordpress",
    name: "WordPress",
        ...
        <section key={channel.id} className={index % 2 ? "bg-spread-ink/[0.02]" : undefined}>
          <Section className="grid gap-8 py-14">
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              ...
              <TagCard title="추천 방식" tags={channel.tactics} />
            </div>
          </Section>
        </section>
      ))}
